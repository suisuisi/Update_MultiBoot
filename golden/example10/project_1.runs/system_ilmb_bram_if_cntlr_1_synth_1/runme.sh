...
HD_PWD='C:/Users/openfpga/Desktop/project/golden/example9_3/project_1.runs/system_ilmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ilmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ilmb_bram_if_cntlr_1.tcl
