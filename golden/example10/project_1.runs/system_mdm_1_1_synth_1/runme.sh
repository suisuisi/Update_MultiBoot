...
HD_PWD='C:/Users/openfpga/Desktop/project/golden/example9_3/project_1.runs/system_mdm_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mdm_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mdm_1_1.tcl
