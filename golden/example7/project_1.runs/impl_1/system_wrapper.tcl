namespace eval ::optrace {
  variable script "E:/project/golden/example6/project_1.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/project/golden/example6/project_1.cache/wt [current_project]
  set_property parent.project_path E:/project/golden/example6/project_1.xpr [current_project]
  set_property ip_output_repo E:/project/golden/example6/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/project/golden/example6/project_1.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/project/golden/example6/project_1.srcs/sources_1/bd/system/system.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc E:/project/golden/example6/project_1.srcs/constrs_1/new/sys.xdc
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top system_wrapper -part xc7vx690tffg1927-2 
