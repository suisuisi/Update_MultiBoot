...
HD_PWD='C:/Users/openfpga/Desktop/project/golden/example9_4/project_1.runs/system_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_microblaze_0_1.tcl
