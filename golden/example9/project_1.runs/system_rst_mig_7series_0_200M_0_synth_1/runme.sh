...
HD_PWD='C:/Users/openfpga/Desktop/project/golden/example9_4/project_1.runs/system_rst_mig_7series_0_200M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_mig_7series_0_200M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_mig_7series_0_200M_0.tcl
