...
HD_PWD='C:/Users/openfpga/Desktop/project/multiboot/example4_idcode/project_1.runs/icape2_ctrl_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icape2_ctrl_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icape2_ctrl_0.tcl
