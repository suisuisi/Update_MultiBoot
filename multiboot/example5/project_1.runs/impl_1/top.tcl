namespace eval ::optrace {
  variable script "E:/project/multiboot/example5/project_1.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/project/multiboot/example5/project_1.cache/wt [current_project]
  set_property parent.project_path E:/project/multiboot/example5/project_1.xpr [current_project]
  set_property ip_output_repo E:/project/multiboot/example5/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/project/multiboot/example5/project_1.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc E:/project/multiboot/example5/project_1.srcs/constrs_1/new/sys.xdc
